...
namespace LinqExercise
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var avererage = numbers.Average();
            Console.WriteLine($"Average: {avererage}");
            ...
            foreach (var item in greaterThenSix)
            {
            ...
            //if their FirstName starts with a C OR an S and order this in ascending
            //order by FirstName.
            var filtered = employees.Where(person => person.FirstName[0] == 'c' || person.FirstName[0] =='s')
                .OrderBy(person => person.FirstName);

            Console.WriteLine("C o S Employees:");
            foreach (var employee in filtered)
            {
                Console.WriteLine(employee.FullName);
            }

            //TODO: Print all the employees' FullName and Age who are over the age 26 to
            //the console and order this by Age first and then by FirstName in the same
            //result.
            ...
            //TODO: Print the Sum of the employees' YearsOfExperience if their YOE is less
            ...
            employees = employees.Append(new Employee("first", "Last Name", 98, 1)).ToList();
